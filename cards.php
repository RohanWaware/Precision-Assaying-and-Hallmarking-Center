                        ...
                        <td>
                            ...
                            <div class="cards">
                                <table width="100%">
                                    <tr>
                                        <td>
                                            <img id='company_logo' src=images/precision_logo.jpg  width="55px">
                                        </td>
                                        <td>
                                            <div class="bussinessname">
                                                <?php echo $business['bussiness_name']; ?><br>
                                ...
                                <table class="card-contents" width="100%" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td data-id="<?php echo str_pad($certificate['certificate_id'], 13, '0', STR_PAD_LEFT); ?>" id='a<?php echo $certificate['certificate_id']; ?>' class="barcode" ></td>
